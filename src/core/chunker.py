...
class CodeChunker:
    ...
    def _chunk_by_structure(self, content: str, file_path: Path, language: str) -> List[CodeChunk]:
    ...
    def _chunk_by_window(self, content: str, file_path: Path, language: str) -> List[CodeChunk]:
